...
<div class="wrap">
    ...
    $setting = [
        ['label' => 'ผู้ใช้งาน', 'url' => ['/site/user']],
        ['label' => 'ตั้งค่า', 'url' => ['/site/setting']],
    ];
    ////////////////////////////////////////////////////////////
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            //submenu
            ['label' => 'report', 'items' => $report],
            ['label' => 'setting', 'items' => $setting],
            //////////////////////////////////////////////
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; HPC2 <?= date('Y') ?></p>
